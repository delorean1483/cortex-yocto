...
SRC_URI = " \
    file://g0b1-apu-1.1.1-slotA.bin \
    file://g0b1-apu-1.1.1-slotB.bin \
    file://manifest.json \
"
S = "${WORKDIR}"
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/g0b1-apu-1.1.1-slotA.bin ${D}${nonarch_base_libdir}/firmware/g0b1-apu/
    install -m 0644 ${WORKDIR}/g0b1-apu-1.1.1-slotB.bin ${D}${nonarch_base_libdir}/firmware/g0b1-apu/
